        ...
        <div class="input-group">
          <style>
            ...
            input#codigo_persona.custom-password-input {
              border: 2px solid #1ACCCF; /* Borde verde */
              border-radius: 25px; /* Bordes redondeados */
              padding: 15px; /* Espaciado interno */
              font-size: 16px; /* Tamaño de la fuente */
              width: 250px; /* Ancho del input */
              background-color: #f4f4f4; /* Color de fondo */
              color: #1ACCCF; /* Color del texto */
...
.btn-primary:hover {
  ...
  border-color: #0056b3; /* Color del borde del botón al pasar el mouse */
          ...
          <input type="text" class="custom-password-input form-control" name="codigo_persona" id="codigo_persona" placeholder="Ingresar ID">
