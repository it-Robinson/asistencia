...
<body>
  ...
  <img src="..\admin\files\Imagenes/coffee_2146193.png" style="width: 80px; height: auto; margin-left: 10px;">
</h3>
...
<h4>**Solo seleccionar una vez:**</h4>
  ...
  <div class="ticket-buttons">
    <a href="asistenciaet.php" class="btn btn-success btn-ticket" data-ticket="Entrada de Turno" style="color: white;">Entrada de Turno</a>
    <a href="asistenciaeb.php" class="btn btn-info btn-ticket" data-ticket="Entrada de Break" style="color: white;">Entrada de Break</a>
    <a href="asistenciasb.php" class="btn btn-warning btn-ticket" data-ticket="Salida de Break" style="color: white;">Salida de Break</a>
    <a href="asistenciast.php" class="btn btn-danger btn-ticket" data-ticket="Salida de Turno" style="color: white;">Salida de Turno</a>
  </div>
</div>
