	...
	case 'listar':
		...
		while ($reg=$rspta->fetch_object()) {
			...
			$data[] = array(
				...
				"1" => '<span style="white-space: nowrap; min-width: 120px;">' . $reg->fecha . '</span>',
				"2" => '<span style="white-space: nowrap; min-width: 120px;">' . $reg->codigo_persona . '</span>',
				"3" => '<span style="white-space: nowrap; min-width: 120px;">' . $reg->nombre . ' ' . $reg->apellidos . '</span>',
				"4" => '<span style="white-space: nowrap; min-width: 130px;">' . $reg->departamento . '</span>',                
				"5" => '<span class="editable" data-id="' . $reg->idasistencia . '" data-column="Ingreso_a_Turno" style="background-color: ' . $color_entrada_turno . '; color: ' . $color_texto_entrada_turno . '; font-weight: bold; text-align: center; display: block; margin: auto; min-width: 120px;">' . $reg->Ingreso_a_Turno . '</span>',
				"6" => '<span class="editable" data-id="' . $reg->idasistencia . '" data-column="Ingreso_a_Break" style="background-color: ' . $color_entrada_break . '; color: ' . $color_texto_entrada_break . '; font-weight: bold; text-align: center; display: block; margin: auto; min-width: 120px;">' . $reg->Ingreso_a_Break . '</span>',
				"7" => '<span class="editable" data-id="' . $reg->idasistencia . '" data-column="Salida_a_Break" style="background-color: ' . $color_salida_break . '; color: ' . $color_texto_salida_break . '; font-weight: bold; text-align: center; display: block; margin: auto; min-width: 120px;">' . $reg->Salida_a_Break . '</span>',
				"8" => '<span class="editable" data-id="' . $reg->idasistencia . '" data-column="Salida_de_Turno" style="background-color: ' . $color_salida_turno . '; color: ' . $color_texto_salida_turno . '; font-weight: bold; text-align: center; display: block; margin: auto; min-width: 120px;">' . $reg->Salida_de_Turno . '</span>'
			);
		}
    ...
    $idusuario=$_SESSION["idusuario"];
		...
		while ($reg=$rspta->fetch_object()) {
			...
			$data[]=array(
				...
				"4" => '<span style="background-color: ' . $color_entrada_turno . '; color: ' . $color_texto_entrada_turno . '; font-weight: bold; text-align: center; display: block; margin: auto; min-width: 120px;">' . $reg->Ingreso_a_Turno . '</span>',
				"5" => '<span style="background-color: ' . $color_entrada_break . '; color: ' . $color_texto_entrada_break . '; font-weight: bold; text-align: center; display: block; margin: auto; min-width: 120px;">' . $reg->Ingreso_a_Break . '</span>',
				"6" => '<span style="background-color: ' . $color_salida_break . '; color: ' . $color_texto_salida_break . '; font-weight: bold; text-align: center; display: block; margin: auto; min-width: 120px;">' . $reg->Salida_a_Break . '</span>',
				"7" => '<span style="background-color: ' . $color_salida_turno . '; color: ' . $color_texto_salida_turno . '; font-weight: bold; text-align: center; display: block; margin: auto; min-width: 120px;">' . $reg->Salida_de_Turno . '</span>'
